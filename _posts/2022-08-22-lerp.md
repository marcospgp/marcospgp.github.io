...
[^2]: Making $$d$$ a multiple of a measure of time (total time elapsed in this case, but also $$\Delta time$$ below) makes the process almost entirely frame rate independent, but not completely so.
