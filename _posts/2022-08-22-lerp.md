...
[^0]: Assuming a steady frame rate, frame number is equivalent to time elapsed. Making $$d$$ a multiple of the time since the last frame also help mitigate frame rate fluctuation related issues, but does not make lerp completely frame rate independent.
