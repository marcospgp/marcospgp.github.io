...
[^2]: Making $$d$$ a multiple of time ensures $$lerp$$ is based on time and not on how many frames have elapsed, which tend to not be perfectly related values due to framerate fluctuations.
