...
I decided not to try this route for now - an additional camera seems like it would make the scene too complex compared to alternatives, and might also have a higher impact on performance (depending on how Unity implements it).
