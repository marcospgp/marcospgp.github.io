...
There is an issue with animation blending in Unity where root motion isn't scaled linearly. For example, blending halfway between an idle and a running animation will have the character moving substantially slower than half the running animation speed.

<https://kybernetik.com.au/animancer/docs/manual/blending/mixers/#synchronisation>
